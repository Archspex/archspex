  ...
  return `<div class="prod-card" onclick="openProduct(${pidStr})">
    <div class="prod-img-wrap">
      ...
      <button class="prod-wish" onclick="event.stopPropagation();handleWish(${pidStr},this)">
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M6 10.5L1 5.5a3 3 0 115-4.5L6 1l.5-.5a3 3 0 115 4.5L6 10.5z" stroke="#6b7685" stroke-width="1.3"></path></svg>
      </button>
    </div>
    <div class="prod-body">
...
function renderProductModal(p, modalRight){
  ...
  modalRight.innerHTML = `
    ...
    <div class="docs-row">
      <div class="doc-item"><div class="doc-icon"><svg width="14" height="14" viewBox="0 0 14 14" fill="none"><rect x="2" y="1" width="10" height="12" rx="1" stroke="var(--navy)" stroke-width="1.3"></rect><line x1="4" y1="4.5" x2="10" y2="4.5" stroke="var(--navy)" stroke-width="1" opacity=".5"></line><line x1="4" y1="6.5" x2="10" y2="6.5" stroke="var(--navy)" stroke-width="1" opacity=".5"></line></svg></div><div><div class="doc-name">Technical Data Sheet</div><div class="doc-size">PDF</div></div><div class="doc-dl">Download ↓</div></div>
      <div class="doc-item"><div class="doc-icon"><svg width="14" height="14" viewBox="0 0 14 14" fill="none"><rect x="1" y="1" width="12" height="12" rx="1" stroke="var(--navy)" stroke-width="1.3"></rect></svg></div><div><div class="doc-name">BIM / CAD File</div><div class="doc-size">RVT · DWG</div></div><div class="doc-dl">Download ↓</div></div>
    </div>
