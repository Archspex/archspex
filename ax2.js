...
async function openBrandProfile(id){
  ...
  page.innerHTML =
    ...
    '<div style="background:linear-gradient(135deg,#001a3d 0%,#003366 55%,#00254d 100%);position:relative;overflow:hidden">'
      ...
      // Top bar — Back to Brands
      + '<div class="bp-padx" style="max-width:1180px;margin:0 auto;padding:22px 48px 0;position:relative">'
      ...
      + '<div class="bp-padx bp-hero-main" style="max-width:1180px;margin:0 auto;padding:38px 48px 34px;position:relative;display:flex;align-items:flex-end;gap:32px;flex-wrap:wrap">'
        // Logo box
        + '<div style="width:108px;height:108px;border-radius:22px;background:#fff;display:flex;align-items:center;justify-content:center;font-size:34px;font-weight:900;color:var(--navy);flex-shrink:0;box-shadow:0 18px 42px rgba(0,0,0,.45),inset 0 0 0 4px rgba(201,168,76,.20);letter-spacing:-1px">' + initials + '</div>'

        // Info column
        + '<div style="flex:1;min-width:280px">'
          // Pills row: Featured + Verified
          + '<div style="display:flex;gap:8px;margin-bottom:14px;flex-wrap:wrap">'
            + (brand.featured ? '<span style="display:inline-flex;align-items:center;gap:5px;font-size:10px;font-weight:800;color:var(--navy);background:var(--gold);padding:5px 11px;border-radius:100px;text-transform:uppercase;letter-spacing:1px"><svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor"><path d="M12 .587l3.668 7.568 8.332 1.151-6.064 5.828 1.48 8.279L12 18.896l-7.416 4.517 1.48-8.279L0 9.306l8.332-1.151z"/></svg>Featured Partner</span>' : '')
            + '<span style="display:inline-flex;align-items:center;gap:5px;font-size:10px;font-weight:700;color:rgba(255,255,255,.92);background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.18);padding:5px 11px;border-radius:100px;text-transform:uppercase;letter-spacing:.5px"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>Verified Brand</span>'
          + '</div>'
          // Brand name
          + '<h1 class="bp-hero-h1" style="font-family:Fraunces,serif;font-size:46px;font-weight:300;color:#fff;line-height:1.05;margin:0 0 14px;letter-spacing:-1px">' + (brand.name||'') + '</h1>'
          // Location + Founded row with icons
          + '<div style="display:flex;align-items:center;gap:14px;font-size:13px;color:rgba(255,255,255,.72);margin-bottom:16px;flex-wrap:wrap">'
      ...
      + '<div class="bp-padx" style="max-width:1180px;margin:0 auto;padding:0 48px 38px;position:relative">'
        + '<div class="bp-stats-row" style="display:grid;grid-template-columns:repeat(4,1fr);gap:1px;background:rgba(255,255,255,.10);border:1px solid rgba(255,255,255,.10);border-radius:14px;overflow:hidden">'
          + '<div class="bp-stat-tile"><div style="font-size:10px;font-weight:700;color:rgba(255,255,255,.55);text-transform:uppercase;letter-spacing:.8px;margin-bottom:8px">Products</div><div style="font-size:24px;font-weight:300;color:#fff;font-family:Fraunces,serif;line-height:1">' + list.length + '</div></div>'
          + '<div class="bp-stat-tile"><div style="font-size:10px;font-weight:700;color:rgba(255,255,255,.55);text-transform:uppercase;letter-spacing:.8px;margin-bottom:8px">Founded</div><div style="font-size:24px;font-weight:300;color:#fff;font-family:Fraunces,serif;line-height:1">' + (brand.founded||'\u2014') + '</div></div>'
          + '<div class="bp-stat-tile"><div style="font-size:10px;font-weight:700;color:rgba(255,255,255,.55);text-transform:uppercase;letter-spacing:.8px;margin-bottom:8px">Employees</div><div style="font-size:24px;font-weight:300;color:#fff;font-family:Fraunces,serif;line-height:1">' + (brand.employees||'\u2014') + '</div></div>'
          + '<div class="bp-stat-tile"><div style="font-size:10px;font-weight:700;color:rgba(255,255,255,.55);text-transform:uppercase;letter-spacing:.8px;margin-bottom:8px">Headquarters</div><div style="font-size:13px;font-weight:600;color:#fff;line-height:1.35">' + (loc||'\u2014') + '</div></div>'
        + '</div>'
      + '</div>'
    + '</div>'
    ...
    + '<div style="background:white;border-bottom:1px solid var(--border)">'
      + '<div class="bp-padx" style="max-width:1180px;margin:0 auto;padding:0 48px;display:flex;gap:32px">'
        + '<a class="bp-tab active" onclick="bpScrollTo(\'bp-about\',this)">About</a>'
        + '<a class="bp-tab" onclick="bpScrollTo(\'bp-products\',this)">Products' + (list.length ? ' <span style="color:var(--muted);font-weight:500">(' + list.length + ')</span>' : '') + '</a>'
        + '<a class="bp-tab" onclick="bpScrollTo(\'bp-gallery\',this)">Gallery</a>'
      + '</div>'
    + '</div>'

    // ═══ ABOUT ══════════════════════════════════════════════════════
    + '<div id="bp-about" class="bp-padx" style="background:#f8f9fc;padding:60px 48px;scroll-margin-top:80px">'
    ...
    // ═══ PRODUCTS ═══════════════════════════════════════════════════
    + '<div id="bp-products" class="bp-padx" style="background:white;padding:60px 48px;scroll-margin-top:80px">'
      + '<div style="max-width:1180px;margin:0 auto">'
    ...
    // ═══ GALLERY ════════════════════════════════════════════════════
    + '<div id="bp-gallery" class="bp-padx" style="background:#f8f9fc;padding:60px 48px 80px;scroll-margin-top:80px">'
      + '<div style="max-width:1180px;margin:0 auto">'
