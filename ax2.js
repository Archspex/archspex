...
(function _injectBrandCardV2CSS(){
  ...
  var css = ''
    ...
    + '.bcv2-head{flex:1 !important;min-width:0;padding-top:68px !important;display:flex;flex-direction:column;gap:8px}'
    ...
    + '.bcv2-market + .bcv2-market{margin-left:8px;padding-left:8px !important;border-left:1px solid #CBD5E1 !important}'
