...
function prodCard(p){
  ...
  var _ICONS = {
    ...
    Fire:       {t:'Fire Rated', s:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2s4 4 4 8a4 4 0 0 1-8 0c0-1.5.5-2.5 1-3.5C8 8 9 9 10 9c0-2 1-4 2-7z"/><path d="M16 12c2 1 4 4 4 7a8 8 0 0 1-16 0c0-1 .3-2 .7-3"/></svg>'},
