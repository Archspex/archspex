...
(function _injectBrandCardV2CSS(){
  ...
  var css = ''
    ...
    + '.bcv2-head{flex:1 !important;min-width:0;padding-top:24px !important;display:flex;flex-direction:column;gap:2px}'
    // Name — matches .prod-name (12px/600/ink/lh 1.4)
    + '.bcv2-name{font-size:12px;font-weight:600;color:#0A1A2C;line-height:1.4;letter-spacing:0;margin:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
    ...
    + '.bcv2-view,.bcv2-contact{flex:1;display:inline-flex;align-items:center;justify-content:center;font-family:Manrope,sans-serif;font-size:9px;font-weight:700;border-radius:7px;padding:7px;cursor:pointer;letter-spacing:.3px;line-height:1;text-transform:uppercase;transition:background .2s, border-color .2s;border:none}'
    + '.bcv2-view{background:#003366;color:#FFFFFF}'
    + '.bcv2-view:hover{background:#001A3D}'
    + '.bcv2-contact{background:#FFFFFF;color:#003366;border:1.5px solid #CBD5E1}'
