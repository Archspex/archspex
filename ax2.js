...
(function _injectBrandCardV2CSS(){
  ...
  var css = ''
    ...
    + '.bcv2-logo-row{display:flex;align-items:flex-start;gap:20px;margin-top:-90px}'
    + '.bcv2-logo{width:180px !important;height:180px !important;background:#FFFFFF;border:1px solid #E5E7EB;border-radius:12px;box-shadow:0 1px 2px rgba(0,15,40,.04),0 1px 3px rgba(0,15,40,.06);display:flex;align-items:center;justify-content:center;overflow:hidden;flex-shrink:0;color:#003366;font-size:16px;font-weight:800}'
    + '.bcv2-logo img{max-width:82%;max-height:82%;object-fit:contain;display:block}'
    + '.bcv2-head{flex:1 !important;min-width:0;padding-top:112px !important;display:flex;flex-direction:column;gap:0}'
