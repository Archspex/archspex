...
(function _injectBrandCardV2CSS(){
  ...
  var css = ''
    ...
    // ── Card shell ──────────────────────────────────────────────
    + '.brand-card-v2{position:relative;background:#FFFFFF;border:1px solid #E5E7EB;border-radius:12px;overflow:hidden;cursor:pointer;transition:all 300ms cubic-bezier(.22,1,.36,1);display:flex;flex-direction:column;font-family:Manrope,sans-serif;color:#0A1A2C;box-shadow:0 1px 2px rgba(0,15,40,.04),0 1px 3px rgba(0,15,40,.06)}'
    ...
    + '.bcv2-feat{position:absolute;right:12px;top:52px;background:transparent;border:none;padding:0;border-radius:8px;display:flex;gap:0;align-items:center;cursor:pointer;overflow:hidden;z-index:2;transition:gap 300ms cubic-bezier(.22,1,.36,1),padding 300ms cubic-bezier(.22,1,.36,1),background 300ms cubic-bezier(.22,1,.36,1),box-shadow 300ms cubic-bezier(.22,1,.36,1)}'
    + '.bcv2-feat:hover{gap:8px;padding:8px;background:rgba(255,255,255,.96);box-shadow:0 4px 12px rgba(0,15,40,.08),0 2px 4px rgba(0,15,40,.04)}'
    + '.bcv2-feat-ico{width:32px;height:32px;border-radius:8px;background:#FFFFFF;color:#C9A84C;display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 1px 2px rgba(0,15,40,.04),0 1px 3px rgba(0,15,40,.06);transition:width 300ms cubic-bezier(.22,1,.36,1),height 300ms cubic-bezier(.22,1,.36,1),box-shadow 300ms cubic-bezier(.22,1,.36,1)}'
    + '.bcv2-feat:hover .bcv2-feat-ico{box-shadow:none}'
    + '.bcv2-feat-ico svg{width:16px;height:16px;display:block}'
    + '.bcv2-feat-text{max-width:0;overflow:hidden;opacity:0;transform:translateX(-4px);transition:max-width 300ms cubic-bezier(.22,1,.36,1),opacity 150ms cubic-bezier(.4,0,.2,1) 50ms,transform 300ms cubic-bezier(.22,1,.36,1);font-size:12px;font-weight:800;color:#003366;white-space:nowrap;padding-right:4px}'
    + '.bcv2-feat:hover .bcv2-feat-text{max-width:160px;opacity:1;transform:translateX(0)}'
    // ── Body layout ─────────────────────────────────────────────
