...
(function _injectBrandCardV2CSS(){
  ...
  var css = ''
    ...
    + '.bcv2-market{display:inline-flex !important;align-items:center;justify-content:center;gap:6px !important;font-size:12px !important;font-weight:600 !important;color:#003366 !important;background:#FFFFFF !important;border:1px solid #CBD5E1 !important;padding:6px 10px !important;border-radius:8px !important;line-height:1.2 !important;flex:1 1 0 !important;min-width:0 !important;white-space:nowrap !important;box-sizing:border-box}'
    + '.bcv2-market + .bcv2-market{border-left:1px solid #CBD5E1 !important}'
    + '.bcv2-market img{width:14px !important;height:auto !important;border-radius:2px !important;box-shadow:0 0 0 1px rgba(0,15,40,.08);display:block;flex-shrink:0;margin:0 !important}'
    + '.bcv2-market-name{}'
    + '.bcv2-check{width:12px !important;height:12px !important;flex-shrink:0}'
    // ── Stat tiles ──────────────────────────────────────────────
