...
// products page view (all / featured / new) from mega menu
...
function applyAndRender(){
  ...
  // ordering: explicit sort wins, else 'new' view sorts newest, else featured/default order
...
function sortProds(val){
  // Sorting stays on the current page/view; just re-orders in place.
