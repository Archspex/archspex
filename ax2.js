...
(function _injectBrandCardV2CSS(){
  ...
  var css = ''
    ...
    // ---- Featured Brand badge (mirrors pp-spec-overlay hover-expand pill) ---
    + '.bcv2-feat{position:absolute;right:12px;top:52px;background:transparent;border:none;padding:0;border-radius:8px;display:flex;flex-direction:row-reverse;gap:0;align-items:center;cursor:pointer;overflow:hidden;z-index:2;transition:gap 300ms cubic-bezier(.22,1,.36,1),padding 300ms cubic-bezier(.22,1,.36,1),background 300ms cubic-bezier(.22,1,.36,1),box-shadow 300ms cubic-bezier(.22,1,.36,1)}'
    + '.bcv2-feat:hover{gap:8px;padding:0 0 0 8px;background:rgba(255,255,255,.96);box-shadow:0 4px 12px rgba(0,15,40,.08),0 2px 4px rgba(0,15,40,.04)}'
    + '.bcv2-feat-ico{width:32px;height:32px;border-radius:8px;background:#FFFFFF;color:#C9A84C;display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 1px 2px rgba(0,15,40,.04),0 1px 3px rgba(0,15,40,.06);transition:box-shadow 300ms cubic-bezier(.22,1,.36,1)}'
    + '.bcv2-feat:hover .bcv2-feat-ico{box-shadow:none}'
    + '.bcv2-feat-ico svg{width:16px;height:16px;display:block}'
    + '.bcv2-feat-text{max-width:0;overflow:hidden;opacity:0;transition:max-width 300ms cubic-bezier(.22,1,.36,1),opacity 150ms cubic-bezier(.4,0,.2,1) 50ms;font-size:12px;font-weight:800;color:#003366;white-space:nowrap;line-height:1.3}'
    ...
    + '.bcv2-head{flex:1 !important;min-width:0;padding-top:68px !important;display:flex;flex-direction:column;gap:4px}'
    + '.bcv2-name{font-size:24px;font-weight:600;color:#003366;line-height:1.1;letter-spacing:-.4px;margin:0;white-space:nowrap;overflow:visible}'
    + '.bcv2-country{display:inline-flex;align-items:center;gap:0;font-size:12px;font-weight:500;color:#0A1A2C;line-height:1.1;margin:0}'
    + '.bcv2-focus{font-size:12px;font-weight:600;color:#C9A84C;letter-spacing:0;line-height:1.1;margin:0;white-space:nowrap;overflow:visible}'
    // ── Description ─────────────────────────────────────────────
    ...
    // ── Market availability ─────────────────────────────────────
    + '.bcv2-mrk-label{font-size:12px;font-weight:600;color:#4B5566;letter-spacing:0;line-height:1.3;margin:0}'
    + '.bcv2-markets{display:flex !important;flex-wrap:nowrap !important;align-items:center;gap:0 !important;border:none !important;padding:0 !important}'
    + '.bcv2-market{display:inline-flex !important;align-items:center;justify-content:flex-start;font-size:12px !important;font-weight:600 !important;color:#003366 !important;background:transparent !important;border:none !important;padding:0 !important;border-radius:0 !important;line-height:1.3 !important;white-space:nowrap !important;box-sizing:border-box}'
    + '.bcv2-market + .bcv2-market{margin-left:16px;padding-left:16px !important;border-left:1px solid #CBD5E1 !important}'
    + '.bcv2-market img,.bcv2-check{display:none !important}'
    + '.bcv2-market-name{margin:0}'
    // ── Stat tiles ──────────────────────────────────────────────
    + '.bcv2-stats{display:grid !important;grid-template-columns:repeat(4,1fr) !important;gap:8px !important;padding:0 !important;align-items:center}'
    + '.bcv2-stat{display:flex !important;align-items:center;gap:8px !important;padding:0 !important;min-width:0;overflow:visible !important}'
    + '.bcv2-stat + .bcv2-stat{border-left:none !important}'
    + '.bcv2-stat-ico{width:28px !important;height:28px !important;border-radius:8px;background:#F8FAFC;color:#003366;display:inline-flex !important;align-items:center;justify-content:center;flex-shrink:0}'
