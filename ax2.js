...
(function _injectBrandCardV2CSS(){
  ...
  var css = ''
    ...
    + '.bcv2-focus{font-size:12px;font-weight:800;color:#C9A84C;letter-spacing:0;line-height:1.1;margin:0}'
    // ── Description ─────────────────────────────────────────────
    ...
    // ── Stat tiles ──────────────────────────────────────────────
    + '.bcv2-stats{display:flex !important;flex-wrap:nowrap !important;align-items:center !important;justify-content:space-between !important;gap:0 !important;padding:0 !important}'
    + '.bcv2-stat{display:flex !important;align-items:center;gap:10px !important;padding:2px 12px !important;min-width:0;flex:1 1 auto;overflow:visible !important;position:relative}'
    + '.bcv2-stat + .bcv2-stat{border-left:1px solid #E5E7EB !important}'
    + '.bcv2-stat:first-child{padding-left:0 !important}'
    + '.bcv2-stat:last-child{padding-right:0 !important}'
    + '.bcv2-stat-ico{width:32px !important;height:32px !important;border-radius:8px;background:#F8FAFC;color:#003366;display:inline-flex !important;align-items:center;justify-content:center;flex-shrink:0}'
    + '.bcv2-stat-ico svg{width:16px !important;height:16px !important;display:block;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}'
    ...
    + '.bcv2-stat-txt b{font-size:16px !important;font-weight:800 !important;color:#003366 !important;line-height:1.1 !important;white-space:nowrap !important;overflow:visible !important;text-overflow:clip !important}'
    + '.bcv2-stat-txt span{font-size:12px !important;font-weight:600 !important;color:#7A8496 !important;letter-spacing:0 !important;margin-top:2px !important;line-height:1.3 !important;white-space:nowrap !important;overflow:visible !important;text-overflow:clip !important}'
    // ── Actions ─────────────────────────────────────────────────
