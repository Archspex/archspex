...
function showPage(page, pushHistory=true){
  ...
  document.querySelectorAll('.nav-link').forEach(function(l){
    ...
    var btn_page = l.getAttribute('onclick')||'';
    var active = false;
    if(btn_page.indexOf("showPage('"+page+"')") >= 0) active = true;
    if(page==='manufacturers' && btn_page.indexOf('manufacturers') >= 0) active = true;
    if(page==='guides' && btn_page.indexOf('guides') >= 0) active = true;
