...
function toggleNavSearch(){
  var wrap = document.getElementById('navSearchExpand');
  var inp = document.getElementById('navSearchInput');
  if(!wrap||!inp) return;
  var isOpen = inp.style.width && inp.style.width !== '0px' && inp.style.width !== '0';
  if(isOpen){
    inp.style.width='0'; inp.style.padding='0';
    wrap.style.width='36px'; wrap.style.borderColor='transparent';
    inp.blur();
  } else {
    wrap.style.width='240px'; wrap.style.borderColor='var(--navy)';
    inp.style.width='180px'; inp.style.padding='0 12px 0 0';
    inp.focus();
  }
}
document.addEventListener('click',function(e){
  ...
  if(wrap&&!wrap.contains(e.target)){
    var inp=document.getElementById('navSearchInput');
    if(inp){inp.style.width='0';inp.style.padding='0';}
    wrap.style.width='36px';wrap.style.borderColor='transparent';
  }
});
