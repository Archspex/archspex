...
function setLoggedIn(user){
  ...
  if(navLogin){ navLogin.textContent = 'My Dashboard'; navLogin.onclick = function(){ showPage('dashboard'); }; }
...
function setLoggedOut(){
  ...
  var navLogin = document.querySelector('.nav-login');
  var navSub = document.querySelector('.nav-subscribe');
  if(navLogin){ navLogin.textContent = 'Log In'; navLogin.onclick = function(){ openRegModal('login'); }; }
  if(navSub){ navSub.textContent = 'Register Free'; navSub.onclick = function(){ openRegModal('register'); }; }
}
